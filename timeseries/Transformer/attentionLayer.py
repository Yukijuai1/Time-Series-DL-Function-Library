...
def attentionLayer(d_model,attention_type='Multi-Head-Self-Attention', n_heads=8):
    if attention_type=='Multi-Head-Self-Attention':
        attention=FullAttention()
    elif attention_type=='Prob-Sparse-Self-attention':
