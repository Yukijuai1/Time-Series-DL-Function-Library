...
class TCN(nn.Module):
    def __init__(self, input_size, output_size, num_channels,kernel_size,mlp_hid_size, dropout,if_fix=False):
        ...
        self.linear_c = nn.Linear(int(mlp_hid_size*1.0/2), output_size)
...
def tcnLayer(input_size, output_size, num_channels,kernel_size=3,mlp_hid_size=128, dropout=0.2,if_fix=False):
    return TCN(input_size, output_size, num_channels,kernel_size,mlp_hid_size, dropout,if_fix)
