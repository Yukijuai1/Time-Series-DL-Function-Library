...
def nbeatsLyaer(nb_blocks_per_stack=3,forecast_length=5,backcast_length=10,thetas_dim=(4,8),hidden_layer_units=256):
    return NBeatsNet(device='cuda',stack_types=(NBeatsNet.GENERIC_BLOCK, NBeatsNet.GENERIC_BLOCK),
                        forecast_length=forecast_length,backcast_length=backcast_length,
                        thetas_dim=thetas_dim,hidden_layer_units=hidden_layer_units,
